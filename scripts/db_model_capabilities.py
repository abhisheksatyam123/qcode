...
def seed_data():
    ...
    models_data = [
        ...
        ("opencode", "laguna-s-2.1-free", "Laguna S 2.1 (Free)", "Poolside 118B MoE (8B Active)", 262144, 32768, 1, 1, "70.2% on Terminal-Bench 2.1", "Poolside Official Spec via OpenCode Zen", "Keyless Free Tier", "Code Diffs & Precise File Modifications", int(time.time())),
        ("opencode", "nemotron-3-ultra-free", "Nemotron 3 Ultra (Free)", "NVIDIA 550B MoE (55B Active, Mamba-Transformer)", 1000000, 128000, 1, 1, "Frontier Orchestration / 1M Context", "NVIDIA Official Release via OpenCode Zen", "Keyless Free Tier", "Massive Repository Context (1M) & Deep Reasoning", int(time.time())),
